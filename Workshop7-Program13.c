...
{   
	int choice;
	tab;printf("==================================== M E N U ======================================");
	tab;printf("| 1- Add a new soft drink.                                                        |");
	tab;printf("| 2- Printing out items which belong to a same origin. (Country)                  |");
	tab;printf("| 3- Printing out items whose volumes are between [(ml)__and__(ml)].              |");
	tab;printf("| 4- Printing the list in ascending order based on volumes then prices.           |");
	tab;printf("| 5- Quit.                                                                        |");
	tab;printf("===================================================================================");
